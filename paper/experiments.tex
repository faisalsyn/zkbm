...
\begin{figure*}[ht!]
     \begin{center}
        \subfloat[Latency of synchronous queue locks]{
            \label{fig:first}
            \includegraphics[width=0.25\textwidth]{img/primitives_latencies_varDelay_syncqueue.eps}
        }
        \subfloat[Latency of synchronous TAS]{
           \label{fig:second}
           \includegraphics[width=0.25\textwidth]{img/primitives_latencies_varDelay_syncTAS.eps}
        } %  ------- End of the first row ----------------------%
        \subfloat[Latency of asynchronous queue locks]{
            \label{fig:third}
            \includegraphics[width=0.25\textwidth]{img/primitives_latencies_varDelay_asyncqueue.eps}
        }
        \subfloat[Latency of asynchronous TAS]{
            \label{fig:fourth}
            \includegraphics[width=0.25\textwidth]{img/primitives_latencies_varDelay_asyncTAS.eps}
        }
    \end{center}
    \caption{
